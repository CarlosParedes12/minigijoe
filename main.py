...
object_radius = 20
object_position = None  # Posición del objeto virtual
moving_object = False  # Indicador de si el objeto se está moviendo
...
while cap.isOpened():
        ...
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            if finger_distance < finger_grab_threshold:  
                if not moving_object:
                    moving_object = True
                    object_position = (x, y)  # Guardar la posición del objeto
            else:
                moving_object = False
            
            # Si el objeto se está moviendo, actualizamos su posición
            if moving_object:
                object_position = (x, y)
    ...
    # Si el objeto está en movimiento, dibujar el objeto virtual
    if object_position:
